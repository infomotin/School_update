                                                    ...
                                                    <div class="controls">
                                                        <select name="religion" id="religion" required=""
                                                            ...
                                                            <option value="Christan" {{
                                                                $editData['student']['religion']=='Christan'
                                                                ? 'selected' : '' }}>
                                                                Christan</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="class_id" required="" class="form-control">
                                                            ...
                                                            <option value="{{ $class->id }}" {{ $editData->class_id ==
                                                                $class->id ? 'selected' : '' }}>
                                                                {{ $class->name }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="group_id" required="" class="form-control">
                                                            ...
                                                            <option value="{{ $group->id }}" {{ $editData->group_id ==
                                                                $group->id ? 'selected' : '' }}>
                                                                {{ $group->name }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="shift_id" required="" class="form-control">
                                                            ...
                                                            <option value="{{ $shift->id }}" {{ $editData->shift_id ==
                                                                $shift->id ? 'selected' : '' }}>
                                                                {{ $shift->name }}</option>
                                                            @endforeach
                                                        </select>
