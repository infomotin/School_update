		...
		<section class="content">
			...
			<div class="box">
				<div class="box-header with-border">
					<h4 class="box-title">Edit Service Amount</h4>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
					<div class="row">
						<div class="col">
							<form method="post" action="{{ route('update.service.amount',$editData[0]->service_id) }}">
								@csrf
								<div class="row">
									<div class="col-12">
										<div class="add_item">
											<div class="form-group">
												...
												<div class="controls">
													<select name="fee_category_id" required="" class="form-control">
														...
														<option value="{{ $service->id }}" {{ ($editData['0']->service_id == $service->id)? "selected":"" }}>{{$service->name }}</option>
														@endforeach
													</select>
												</div>
											</div> <!-- // end form group -->
