...
<body>
    ...
    @php
        ...
        $totallateday = collect($totalattend)->where('late_minute','>',0)->count('late_minute');
		$totaldeductday = floor($totallateday/3);
        ...
        $absentcount = count($totalattend->where('attend_status', 'Absent'))+$totaldeductday;
        $totalsalaryminus = ((float) $absentcount * (float) $salaryperday)+(float)$deductedamount;
    ...
    <table id="customers">
        ...
        <tr>
            <td>3</td>
            <td><b>Total Late comming for This Month</b></td>
            <td>{{ $totallateday }}</td>
        </tr>
        <tr>
            <td>4</td>
